...
/*AQUI 1 : validar cliente nullo*/
/*Cuando se sube el servidor carpeta upload vacia? */
...
import com.ied.spring.boot.backend.apirest.models.services.IUploadFileService;
...
public class ClienteRestController {
    ...
    public ResponseEntity<?> create(@Valid @RequestBody Cliente cliente, BindingResult result) {
        ...
        Map<String, Object> response = new HashMap<>();
        System.out.println(" 1  result.getFieldErrors() : ");
    ...
    public ResponseEntity<?> upload (@RequestParam("archivo")MultipartFile archivo, @RequestParam("id")Long id){
        ...
        if(!archivo.isEmpty()){
            ...
            try {
                log.info("******* INFO: "+archivo.getContentType()) ;
