...
import com.ied.spring.boot.backend.apirest.models.dao.IClienteDao;
import com.ied.spring.boot.backend.apirest.models.dao.IFacturaDao;
...
public class ClienteServiceImpl implements IClienteService{
    ...
    @Autowired
    private IClienteDao clienteDao;    //Se inyecta el Dao(repositorio) para que el servicio este limpio
